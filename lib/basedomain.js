...
function URI(/**String*/ spec)
{
  ...
  var trailingSlash = spec.substring(this._hostPortStart).match(/\/|\?|\#/);
  this._hostPortEnd = trailingSlash?trailingSlash.index+this._hostPortStart:spec.length;
...
URI.prototype =
{
  ...
  get path()
  {
    if(this.spec.charAt(this._hostPortEnd) == "/")
